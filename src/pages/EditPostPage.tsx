...
const EditPostPage: React.FC = () => {
  ...
  const handleSave = (status: 'draft' | 'published' = formData.status as 'draft' | 'published') => {
    ...
    console.log(`Updating post as ${status}:`, updatedPost);
    navigate('/admin');
  };
        ...
        <div className="flex items-center justify-between mb-8 animate-organic-fade-up">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-gray-400">Update and manage your blog post</p>
            </div>
          ...
          <div className="flex space-x-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all duration-300 hover:scale-105"
            >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-900 p-6 rounded-lg border border-gray-800">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-gray-800 rounded-lg">
                      <div>
                        <p className="text-white font-medium">Post Created</p>
                        <p className="text-gray-400 text-sm">{formData.date}</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-800 rounded-lg">
                      <div>
                        <p className="text-white font-medium">Last Modified</p>
                        <p className="text-gray-400 text-sm">Today at 2:30 PM</p>
                      </div>
                      <span className="text-blue-400 text-sm">Auto-saved</span>
                    </div>
                  </div>
                </div>
              </div>
